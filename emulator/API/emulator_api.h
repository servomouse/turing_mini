...
DLL_PREFIX void mem_write(uint32_t memspace, uint32_t offset, uint32_t len, uint8_t *data);
DLL_PREFIX void mem_read(uint32_t memspace, uint32_t offset, uint32_t len, uint8_t *data);
